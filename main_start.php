...
<div class="sub">
	...
	<span>Kamusta!! &nbsp<?php echo $result['fname']; ?></span>
		</div>
		<div class="choice"><center><a href="main.php"> <button type="submit" action="" class="questionaire">Simulan</button> </center></div></a>
		</div>
