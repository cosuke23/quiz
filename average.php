...
<div class="menu"><div class="logos">
	...
	<audio class="audio" controls="controls" onloadeddata="var audioPlayer = this;setTimeout(function(){audioPlayer.play();},16000)">
	<source src="clock.mp3" type="audio/mp3">
</audio>
<audio class="audio" controls="controls" onloadeddata="var audioPlayer = this;setTimeout(function(){audioPlayer.play();},28000)">
...
<div class="header">
	...
	<li><a href="final_result.php"  target="_blank">Results</a></li></ul>
	</div>
	</div>
</div>
...
?>
	...
	<table>
		...
		<tr><th style="width: 100px;">Question no</th>
			...
			<?php
$type=$_GET['quiz_type'];
$select = mysqli_query($conn,"SELECT * from identification where type ='$type' order by question_no DESC");
...
<td class="log"><div class="logos">
	<a class="edit" href="admin.php?update=true&&question=<?php echo $result['main_question']; ?>">edit</a>
		...
		<a href="dispaly_avg.php?type=<?php echo $result['type']; ?>&&question=<?php echo $result['question']; ?>&&title=<?php echo $result['question_title']; ?>&correct=<?php echo $result['answer']; ?>&&no=<?php echo $result['id']; ?>" class="display" style=" margin-bottom: 5px;">display</a>
</div></td>
			</tr>
    <?php
...
display: none;
    ...
    color: red;
		...
		<form action="submit_average.php" method="POST">
			<h2>Add Questions</h2>
			<div class="inputs">
				<input type="text" name="type" value="average"  required>
